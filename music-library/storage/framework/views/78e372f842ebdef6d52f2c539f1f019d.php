                                            ...
                                            <div class="bg-neutral-50 dark:bg-neutral-900 relative mb-3 pb-1 pt-1 text-center">
                                                <div class="relative bg-inherit ">
                                                    <input 
                                                        ...
                                                        id="email" 
                                                        name="email" 
                                                        class="peer bg-transparent h-10 w-full rounded-lg text-gray-700 dark:text-neutral-50 placeholder-transparent ring-1 px-2 ring-gray-200 focus:ring-sky-600 dark:focus:ring-cyan-600 focus:outline-none focus:border-rose-600  <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?> peer bg-transparent h-10 w-full rounded-lg text-gray-700 dark:text-neutral-50 placeholder-transparent ring-1 px-2 ring-gray-200 focus:ring-sky-600 dark:focus:ring-cyan-600 focus:outline-none focus:border-rose-600" 
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="bg-neutral-50 dark:bg-neutral-900 relative mb-2">
                                                <div class="relative bg-inherit">
                                                    <div class="form-check">
                                                        <input class="checked:bg-gray-700 dark:checked:bg-cyan-700 form-check-input" type="checkbox" name="remember" id="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
                                            ...
                                            <?php if(Route::has('password.request')): ?>
                                                ...
                                                <a href="<?php echo e(route('password.request')); ?>" class=" active:animate-bounce hover:animate-pulse dark:text-neutral-50 bg-gradient-to-r from-gray-900 to-gray-700 dark:bg-gradient-to-r dark:from-neutral-50 dark:to-neutral-50 bg-clip-text text-transparent">
...
<?php /**PATH E:\XamppRepo\htdocs\xampp\MusicLibrary\music-library\resources\views/auth/login.blade.php ENDPATH**/ ?>