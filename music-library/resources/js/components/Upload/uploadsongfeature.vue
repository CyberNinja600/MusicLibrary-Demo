<template>
  ...
  <div class="absolute bg-neutral-500  shadow-neutral-50 select-none text-white dark:text-white scroll-container custom-scrollbar dark:darkcustom-scrollbar rounded-lg flex w-[210px] md:w-[270px] lg:w-[370px] xl:w-[500px] 2xl:w-[600px] h-[100px] overflow-auto">
